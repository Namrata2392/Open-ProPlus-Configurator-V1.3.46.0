...
{
    /**
    * \brief     <b>ucMasterLoadProfile</b> is a user interface to display all IED's & LoadProfile parameters
    * \details   This is a user interface to display all IED's & LoadProfile parameters. It provides interface
    * to add multiple IED's. The user can also modify IED's parameters.
    * 
    * 
    */
    public partial class ucMasterLoadProfile : UserControl
    {
        ...
        public ucMasterLoadProfile()
        {
            ...
            //txtLPDescription.BackColor = System.Drawing.SystemColors.Window;//To make background white for disabled control...
        ...
        private void txtTapRatio_KeyPress(object sender, KeyPressEventArgs e)
        {
            Utils.allowNumbersOnly(sender, e, false, true);
        }

        private void txtTxOffsetCurrent_KeyPress(object sender, KeyPressEventArgs e)
        {
            Utils.allowNumbersOnly(sender, e, false, true);
        }
        ...
        {
            Utils.allowOnlyCapAlphabetAndUnderscore(sender, e, false, false);
        }
