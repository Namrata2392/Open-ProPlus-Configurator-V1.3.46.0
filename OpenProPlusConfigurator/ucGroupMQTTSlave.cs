...
{
    public partial class ucGroupMQTTSlave : UserControl
    {
        ...
        public event ItemCheckEventHandler lvMQTTSlaveItemCheck;
        public event EventHandler lvMQTTSlaveDoubleClick;
        public ucGroupMQTTSlave()
        {
            InitializeComponent();
            // Ajay: 23/11/2018
        ...
        {
            Utils.handleMouseMove(grpMQTTSlave, sender, e);
        }
        ...
        {
            if (lvMQTTSlaveItemCheck != null)
                lvMQTTSlaveItemCheck(sender, e);
        }

        private void lvMQTTSlave_DoubleClick(object sender, EventArgs e)
        {
            if (lvMQTTSlaveDoubleClick != null)
                lvMQTTSlaveDoubleClick(sender, e);
        }

        private void lvMQTTSlave_SelectedIndexChanged(object sender, EventArgs e)
        {
