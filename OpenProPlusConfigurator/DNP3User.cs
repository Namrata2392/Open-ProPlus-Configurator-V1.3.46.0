...
namespace OpenProPlusConfigurator
{
    ...
    public class DNP3User
    {
        ...
        private string no = ""; private string name = ""; private string key = "";
        private bool grantForControl = true;
        public static string[] arrAttributes = { "No", "Name", "Key" };
        public DNP3User(string smsUserName, List<KeyValuePair<string, string>> smsuserData, TreeNode tn, int mNo)
        {
        ...
        public DNP3User(XmlNode sNode, TreeNode tn)
        {
            string strRoutineName = "SMSUser";
            try
            {
        ...
        public XmlNode exportXMLnode()
        {
            ...
            rootNode = xmlDoc.CreateElement("User");
            xmlDoc.AppendChild(rootNode);
