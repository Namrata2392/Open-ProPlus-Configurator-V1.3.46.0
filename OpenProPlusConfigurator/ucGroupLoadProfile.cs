...
namespace OpenProPlusConfigurator
{
    ...
    * 
    */
    public partial class ucGroupLoadProfile : UserControl
    {
        ...
        public event EventHandler lvLoadProfilemasterDoubleClick;
        //public event EventHandler cmbProtocolTypeSelectedIndexChanged;

        public ucGroupLoadProfile()
        {
            InitializeComponent();
            ...
            {
                if (ProtocolGateway.OppLoadProfileGroup_ReadOnly)
                {
        ...
        {
            if (lvLoadProfilemasterDoubleClick != null)
                lvLoadProfilemasterDoubleClick(sender, e);
        }
        ...
        {
            Utils.handleMouseMove(grpLoadProfile, sender, e);
        }
        ...
        //}
        public event ItemCheckEventHandler lvLoadProfilemasterItemCheck;
        private void lvLoadProfilemaster_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            if (lvLoadProfilemasterItemCheck != null)
                lvLoadProfilemasterItemCheck(sender, e);
        }

        private void cmbTimeIntrvl_KeyPress(object sender, KeyPressEventArgs e)
        {
            Utils.allowNumbersOnlyForComboBox(sender, e, false, false);
        }

        private void txtTimeIntrvl_KeyPress(object sender, KeyPressEventArgs e)
        {
            Utils.allowNumbersOnly(sender, e, false, false);
        }

        private void lvLoadProfilemaster_SelectedIndexChanged(object sender, EventArgs e)
        {
